...
<div class="row">
<div class="col-lg-4">
<div class="bs-component live-less-editor-hovercontainer" data-relatedvars="list-group-bg,list-group-border,list-group-border-radius,list-group-link-color,list-group-link-heading-color,list-group-hover-bg,list-group-active-color,list-group-active-bg,list-group-active-border,list-group-active-text-color,list-group-link-hover-color">
<ul class="list-group">
